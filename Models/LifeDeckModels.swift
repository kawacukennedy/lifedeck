...
class CompleteAppUser: ObservableObject, Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case achievements, joinDate, subscription, lifeDomains, streaks, preferences, lifePoints
    }
...
// MARK: - User typealias for compatibility
typealias User = CompleteAppUser
